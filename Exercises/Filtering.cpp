...
int main() {
    ...
    const std::vector<GLfloat> VERTICES {
        0.5f,  0.5f, 1.0, 0.0, 0.0, 1.0f, 1.0f, // Upper right corner Red
        0.5f, -0.5f, 0.0, 1.0, 0.0, 1.0f, 0.0f, // Lower right corner Green
       -0.5f, -0.5f, 0.0, 0.0, 1.0, 0.0f, 0.0f, // Lower left corner Blue
       -0.5f,  0.5f, 1.0, 1.0, 1.0, 0.0f, 1.0f, // Upper left corner White
   };
